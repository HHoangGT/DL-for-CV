...
\begin{figure}[H] \centering \includegraphics[width=0.48\textwidth]{images/row_img_2.png} \includegraphics[width=0.48\textwidth]{images/column_img_2.png} \\ \includegraphics[width=0.48\textwidth]{images/patch_img_3.png} \includegraphics[width=0.48\textwidth]{images/gru_learning_curves.png} \caption{Đồ thị Training của 4 cấu hình: Row-wise LSTM, Column-wise LSTM, Patch-wise LSTM và Patch-wise GRU.} \end{figure}
